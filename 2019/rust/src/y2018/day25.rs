    ...
    'outer: for i in 0..len {
        unsafe {
            ...
            for j in (0..len).step_by(8) {
                let d = _mm256_abs_epi8(_mm256_sub_epi8(to_cmp, *(ptr.add(j) as *const __m256i)));
                let d = _mm256_add_epi32(d, _mm256_slli_epi32(d, 16)); // Shift and sum to create cumumlative sum.
                let d = _mm256_add_epi32(d, _mm256_slli_epi32(d, 8));
